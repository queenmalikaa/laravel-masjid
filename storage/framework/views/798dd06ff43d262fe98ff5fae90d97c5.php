...
<?php $component->withAttributes([]); ?>
    <div class="w-full">
        <img class="w-full" src="<?php echo e(asset('/image/masjiddd.png')); ?>"/>
    </div>
    
    <div class="w-full p-12">
        <h1 class="text-4xl text-center font-Times new roman <b> mb-8">LAPORAN KEUANGAN MASJID</h1>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\laravel-masjid\resources\views/landing/index.blade.php ENDPATH**/ ?>